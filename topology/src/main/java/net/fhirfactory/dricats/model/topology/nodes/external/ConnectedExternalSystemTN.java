package net.fhirfactory.dricats.model.topology.nodes.external;
...
public class ConnectedExternalSystemTN implements Serializable {
    private static final Logger LOG = LoggerFactory.getLogger(ConnectedExternalSystemTN.class);
    ...
    public ConnectedExternalSystemTN(){
