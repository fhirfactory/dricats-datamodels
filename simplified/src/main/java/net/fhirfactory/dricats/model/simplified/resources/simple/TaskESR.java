...
import net.fhirfactory.dricats.model.simplified.resources.simple.datatypes.PatientIdentifierESDT;
import net.fhirfactory.dricats.model.simplified.resources.simple.datatypes.PeriodESDT;
...
public class TaskESR {
	...
	public String toString() {
		return "TaskESR{" + "taskId=" + taskId + ", taskFocus=" + taskFocus + ", taskBeneficiary=" + taskBeneficiary + ", taskEncounter=" + taskEncounter + ", taskJourney=" + taskJourney + ", subTasks=" + subTasks + ", taskInput="
				+ taskInput + ", taskOutput=" + taskOutput + ", taskPeriod=" + taskPeriod + ", taskStatus=" + taskStatus + ", taskStatusReason='" + taskStatusReason + ", taskTriggerType=" + taskTriggerType + ", taskTriggerId="
				+ taskTriggerId + ", taskFulfillmentLocation=" + taskFulfillmentLocation + '}';
	}
}
